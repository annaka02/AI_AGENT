...
def get_llm():
    ...
    if "GEMINI_API_KEY" in st.secrets:
        ...
        return ChatGoogleGenerativeAI(model="gemini-1.5-flash-latest", google_api_key=st.secrets["GEMINI_API_KEY"], temperature=0.3, convert_system_message_to_human=True)
